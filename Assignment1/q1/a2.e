...
# 26 "a2.c"
    ...
    for(j=0;j<6;j++) {
        ...
        greet[26] = '\n';
        greet[8] = section;
        greet[23] = avgscr[j]/100+'0';
        greet[24] = (avgscr[j]-avgscr[j]/100*100)/10+'0';
        greet[25] = (avgscr[j]-avgscr[j]/100*100-avgscr[j]/10*10)+'0';
...
int main(int argc, char const* argv[]) {
    ...
    int fd = open("student_record.csv", 
# 70 "a2.c" 3 4
                                       00
# 70 "a2.c"
                                               );
...
# 141 "a2.c"
    ...
    for(j=0;j<6;j++){
        ...
        greet[11] = j+'0'+1;
        greet[17] = '\n';
        greet[14] = asnmavg/100+'0';
        greet[15] = (asnmavg-asnmavg/100*100)/10+'0';
        greet[16] = (asnmavg-asnmavg/100*100-asnmavg/10*10)+'0';
        ssize_t written = write(
# 161 "a2.c" 3 4
                               1
# 161 "a2.c"
